...
const Hero = () => {
  ...
  return (
    <>
      <SplineFile />
      <div className="w-full overflow-hidden backdrop-blur-lg">
            ...
            <div className="space-y-8">
              <div className="space-y-4 text-center md:text-start">
                ...
                <p className="text-lg sm:text-xl text-n-muted_foreground max-w-lg mx-auto md:mx-0">
                  Discover LUMIRA's collection of premium lighting solutions
                  that blend modern design with exceptional functionality for
