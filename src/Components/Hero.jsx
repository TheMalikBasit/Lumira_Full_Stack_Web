        ...
        <div className="container mt-[100px]">
          ...
          <div className="space-y-4 mb-10">
            <h1
              ...
              className="z-30 text-4xl sm:text-5xl lg:text-6xl font-bold text-n-foreground leading-tight"
            >
              Illuminate Your
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button className="mt-5 xl:mt-0 flex flex-row items-center group hover:text-pink-600">
              Shop Collection
